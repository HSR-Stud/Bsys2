...
% Math stuff configuration

\numberwithin{equation}{subsection} % Numer equations with triples
\setcounter{MaxMatrixCols}{20} % Allow large matrices

% Useful macros

\newcommand{\uminus}{\scalebox{0.75}[1.0]{\( - \)}}
...
%\usetikzlibrary{arrows,automata,matrix,decorations.pathreplacing}
